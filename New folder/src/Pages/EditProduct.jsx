...
const EditProduct = () => {
  ...
  const handleUpdate = (id) => {
    ...
    axios
      .patch(`https://fakeapimock-server.onrender.com/products/${id}`, updatedata)
      .then((res) => {
  ...
  return (
    <div className="mt-12  ">
      <h1 className="text-4xl mb-7 font-semibold">Edit Product</h1>
      <div className="w-5/6 sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 m-auto shadow-2xl   ">
        ...
        <input
          ...
          className="block border-2 border-radius-10  text-white bg-cyan-500 w-1/3 mb-96 ml-32 sm:w-1/3  py-1"
        />
      </div>
    </div>
  );
